...
All program code and tests must be versioned in the main **master** branch and **compulsorily** placed in the Software folder. All other artifacts (e.g. images) that you will use in your documentation must be placed in the Documentation folder.
